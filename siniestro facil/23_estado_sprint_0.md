...
| 4. Datos y migraciones | 90% | 22 tablas desplegadas, constraints probados, datos sintéticos, migración SQL y revisión Alembic inicial | Aprobar y ejecutar la revisión en Cloud SQL; fusionar PR #1 |
...
Promedio ponderado y redondeado: **77%**.
...
7. Validar Alembic contra Cloud SQL y registrar la revisión aplicada.
